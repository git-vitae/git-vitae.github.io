      ...
      <div className="grid md:grid-cols-2 gap-8 items-start mb-8">
        ...
        <div className="space-y-5">
          <div className="flex gap-3">
            <div className="w-6 h-6 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
              1
            </div>
            <div>
    ...
    <div className="rounded-2xl border border-border overflow-hidden shadow-lg bg-background max-w-sm mx-auto">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs text-muted-foreground">git-vitae / </span>
      ...
      <div className="p-4 space-y-3">
        <div>
          ...
          <div className="flex items-center gap-1 text-[11px]">
            <span className="text-muted-foreground bg-secondary px-2 py-1.5 rounded-l border border-border">
              janedoe /
            </span>
      ...
      <div className="w-full max-w-xl mx-auto mb-8 grid sm:grid-cols-2 gap-3 text-left">
        <div className="p-3.5 rounded-xl border-2 border-primary/30 bg-primary/5">
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            ...
            <code className="text-primary bg-secondary px-1 rounded font-mono">
      ...
      <div className="rounded-2xl border border-border overflow-hidden shadow-lg bg-background max-w-sm mx-auto">
        ...
        <div className="p-4 font-mono text-[11px] leading-relaxed">
          ...
          <div className="mt-1">
            ...
            <span className="bg-yellow-200/60 dark:bg-yellow-500/20 text-yellow-800 dark:text-yellow-300 px-1 rounded">
              "Git Vitae"
            </span>
            <span className="text-primary/40 text-[10px] ml-1">
              ← change this
            </span>
          </div>
          <div>
      ...
      <div className="flex divide-x divide-border text-[10px]">
        ...
        <div className="w-28 shrink-0 p-3 bg-secondary/40 space-y-0.5">
          ...
          {["General", "Access", "Code security", "Branches"].map((item) => (
            <div key={item} className="px-2 py-1 rounded text-muted-foreground">
              {item}
            </div>
          ))}
      ...
      <div className="w-full max-w-lg mx-auto mb-10 rounded-2xl border border-border overflow-hidden text-left">
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-start gap-3 text-xs">
            <span className="w-5 h-5 rounded-full bg-primary/10 border border-primary/20 text-primary font-bold flex items-center justify-center shrink-0 mt-0.5 text-[10px]">
              1
            </span>
      ...
      <div className="w-full max-w-xl mx-auto mb-10 rounded-2xl border border-border overflow-hidden text-left">
        ...
        <div className="divide-y divide-border">
          ...
          <div className="p-4 flex items-start gap-3">
            <span className="mt-0.5 w-6 h-6 rounded-full bg-[#2ea44f]/10 border border-[#2ea44f]/20 text-[#2ea44f] font-bold text-[10px] flex items-center justify-center shrink-0">
              1
            </span>
            <div>
              ...
              <p className="text-[11px] text-muted-foreground leading-relaxed">
                ...
                type{" "}
                <code className="text-primary text-[10px] bg-secondary px-1 rounded font-mono">
                  YES
                </code>{" "}
          ...
          <div className="p-4 flex items-start gap-3">
            <span className="mt-0.5 w-6 h-6 rounded-full bg-primary/10 border border-primary/20 text-primary font-bold text-[10px] flex items-center justify-center shrink-0">
              2
            </span>
            <div>
              <p className="text-xs font-semibold text-foreground mb-0.5">
          ...
          {/* Path 3 — CLI */}
          <div className="p-4 flex items-start gap-3">
            <span className="mt-0.5 w-6 h-6 rounded-full bg-secondary border border-border text-muted-foreground font-bold text-[10px] flex items-center justify-center shrink-0">
              3
            </span>
            <div>
              <p className="text-xs font-semibold text-foreground mb-0.5">
...
function ProgressBar({ current, total }: { current: number; total: number }) {
  ...
  return (
    <div className="mb-10">
      ...
      <div className="grid grid-cols-6 gap-2 mb-3hidden md:grid grid-cols-6 gap-2 text-center text-xs font-medium text-gray-500">
        {labels.map((label, i) => (
          <span
            key={label}
          ...
          >
            {i < current ? <Check size={12} className="inline mr-0.5" /> : null}
            {label}
          </span>
        ))}
      </div>
